...
#%% Now let's make a more useful function.  This new function will calculate the GC content of a string sequence.  Specifically, it should count the occurences of 'G' in the sequence, and add that number to the occurences of 'C' in the sequence.  The function should finally divide the sum by the total sequence length, and return the result.
